<template>
  <PageWrapper title="因子详情">
    <template #headerContent>
      <a-page-header :title="factorInfo.combinedname || '-'">
        <a-button type="primary" @click="openModal(true)">fan</a-button>
      </a-page-header>
    </template>
    <div class="content">
...
import { lciaColumns, lciColumns } from '/@/views/basic-setting/environmentFactor/factor.data';
import { list, getFactorDetailInfo, getFactorLCIAlist, getlciListInList, getlciListOutList } from '/@/views/basic-setting/environmentFactor/factor.api';
// 因子库信息Model
