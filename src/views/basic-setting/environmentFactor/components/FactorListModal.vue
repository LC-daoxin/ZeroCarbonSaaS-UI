...
<script lang="ts" setup>
  ...
  import { saveOrUpdateDictItem } from '../factor.api';
  import { factorItemColumns, dictItemSearchFormSchema } from '../factor.data';
  import { itemList, deleteItem } from '../factor.api';
  // 声明Emits
  ...
  async function handleSubmit() {
    try {
      ...
      //提交表单
      await saveOrUpdateDictItem({}, isUpdate.value);
      //关闭弹窗
      closeModal();
      //刷新列表
      emit('success');
